...
boolean Plugin_112(byte function, struct EventStruct *event, String& string)
{
        ...
        {
                Plugin_112_Bits = WebServer.arg("plugin_112_bits").toInt();
                Plugin_112_Pulse = WebServer.arg("plugin_112_pulse").toInt();
                Plugin_112_Repeat = WebServer.arg("plugin_112_repeat").toInt();
